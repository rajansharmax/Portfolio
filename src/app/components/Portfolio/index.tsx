                                        ...
                                        <div className="d-flex flex-column gap-2">
                                            ...
                                            >
                                                <div className="d-flex align-items-center gap-2">
                                                    <Image
                                                        src={
                                                            "/assets/imgs/home-page-2/experience/google.svg"
                                                        }
                                                        alt="zelio"
                                                        width={40}
                                                        height={40}
                                            ...
                                            >
                                                <div className="d-flex align-items-center gap-2">
                                                    <Image
                                                        src={
                                                            "/assets/imgs/home-page-2/experience/twitter.svg"
                                                        }
                                                        alt="zelio"
                                                        width={40}
                                                        height={40}
                                            ...
                                            >
                                                <div className="d-flex align-items-center gap-2">
                                                    <Image
                                                        src={
                                                            "/assets/imgs/home-page-2/experience/amazon.svg"
                                                        }
                                                        alt="zelio"
                                                        width={40}
                                                        height={40}
                                            ...
                                            >
                                                <div className="d-flex align-items-center gap-2">
                                                    <Image
                                                        src={
                                                            "/assets/imgs/home-page-2/experience/payPal.svg"
                                                        }
                                                        alt="zelio"
                                                        width={40}
                                                        height={40}
