...
export const siteMetadata = {
    ...
    siteLogo: `${process.env.BASE_PATH || ""}/assets/images/rajansharmax-preview.png`,
    socialBanner: `${process.env.BASE_PATH || ""}/assets/images/rajansharmax-preview.png`,
    ...
    company: {
        ...
        image: `${process.env.BASE_PATH || ""}/assets/images/rajansharmax-preview.png`,
